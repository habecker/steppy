...
class BranchedFlowTest {
    ...
    @Test
    void testBranchedWithPrecedingStep() throws ExecutionException, ValidationException {
        var flow = builder(Integer.class, Integer.class).append(IncrementerStep.class).branch(Integer.class, Integer.class,
            builder -> builder.when((i) -> i < 10, (b) -> b.append(IncrementerStep.class))
                .otherwise(b -> b.append(IncrementerStep.class).append(IncrementerStep.class))).build();
        assertThat(flow.invoke(0).getResult()).isEqualTo(2);
        assertThat(flow.invoke(10).getResult()).isEqualTo(13);
    }

    @Test
    void testBranched() throws ExecutionException, ValidationException {
        var flow = builder(Integer.class, Integer.class).branch(Integer.class, Integer.class,
            builder -> builder.when((i) -> i < 10, (b) -> b.append(IncrementerStep.class))
                .otherwise(b -> b.append(IncrementerStep.class).append(IncrementerStep.class))).build();
        assertThat(flow.invoke(0).getResult()).isEqualTo(1);
        assertThat(flow.invoke(10).getResult()).isEqualTo(12);
    }

    @Test
    void testOtherwiseContinue() throws ExecutionException, ValidationException {
        var flow = builder(Integer.class, Integer.class).branch(Integer.class, Integer.class,
            builder -> builder.when((i) -> i < 10, (b) -> b.append(IncrementerStep.class)).otherwiseContinue()).build();
        assertThat(flow.invoke(0).getResult()).isEqualTo(1);
    ...
    void testMissingBranch() throws ExecutionException, ValidationException {
        var flow = builder(Integer.class, Integer.class).branch(Integer.class, Integer.class,
            builder -> builder.when((i) -> i < 10, (b) -> b.append(IncrementerStep.class))).build();

        var result = flow.invoke(10);
