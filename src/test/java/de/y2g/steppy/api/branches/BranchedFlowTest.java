...
class BranchedFlowTest {
    ...
    void testBranchedWithPrecedingStep() throws ExecutionException, ValidationException {
        var flow = builder(None.class, Integer.class, Integer.class).append(IncrementerStep.class).branch(Integer.class, Integer.class,
            builder -> builder.when((any, i) -> i < 10, (b) -> b.append(IncrementerStep.class))
    ...
    void testBranched() throws ExecutionException, ValidationException {
        var flow = builder(None.class, Integer.class, Integer.class).branch(Integer.class, Integer.class,
            builder -> builder.when((any, i) -> i < 10, (b) -> b.append(IncrementerStep.class))
                .otherwise(b -> b.append(IncrementerStep.class).append(IncrementerStep.class))).build();
    ...
    void testOtherwiseContinue() throws ExecutionException, ValidationException {
        var flow = builder(None.class, Integer.class, Integer.class).branch(Integer.class, Integer.class,
            builder -> builder.when((any, i) -> i < 10, (b) -> b.append(IncrementerStep.class)).otherwiseContinue()).build();
        assertThat(flow.invoke(None.value(), 0).getResult()).isEqualTo(1);
    ...
    void testMissingBranch() throws ExecutionException, ValidationException {
        var flow = builder(None.class, Integer.class, Integer.class).branch(Integer.class, Integer.class,
            builder -> builder.when((any, i) -> i < 10, (b) -> b.append(IncrementerStep.class))).build();
